...
export const upgradesListNotIndex = [
  ...
  [
    ...
    {
      name: 'Пинок',
      description:  'Вы пинаете студента, и он начинает работать эффективнее. Повышает производительность студента в 2 раза',
      cost: 130,
      point: 2,
      informerIndex: '0',
      buffs: [
  ...
  [
    ...
    {
      name: 'Засекречивание',
      description:  'Выступая в суде, ваш студент будет засекречен. Он сможет доносить чаще, не боясь возмездия. Повышает производительность студента в 2 раза',
      cost: 192,
      point: 5,
      informerIndex: '0',
      buffs: [
  ...
  [
    37,
    {
      ...
      description:  'Вы договариваетесь с руководством вуза, и у студента появляется больше времени на доносы. Повышает производительность студента в 2 раза',
      cost: 2655,
      point: 25,
      informerIndex: '0',
      buffs: [
  ...
  [
    38,
    {
      ...
      description: 'Вы обещаете студенту карьеру в правоохранительных органах, он переходит на 16-часовой рабочий день. Повышает производительность студента в 2 раза',
      cost: 70000,
      point: 50,
      informerIndex: '0',
      buffs: [
  ...
  [
    ...
    {
      name: 'Выдача погонов',
      description: 'Погоны, купленные в военторге, повышают рвение студента еще на несколько порядков. Повышает производительность студента в 2 раза',
      cost: 49000000,
      point: 100,
      informerIndex: '0',
      buffs: [
  ...
  [
    ...
    {
      name: 'Святость',
      description: 'Икона на заставке компьютера позволяет старушке молиться, не отрываясь от работы. Повышает производительность набожной старушки в 2 раза',
      cost: 650,
      point: 2,
      informerIndex: '1',
      buffs: [
  ...
  [
    ...
    {
      name: '«Радонеж»',
      description: 'Вы заказываете еженедельную передачу о доносах как долге христианина на радио «Радонеж». Повышает производительность набожной старушки в 2 раза',
      cost: 960,
      point: 5,
      informerIndex: '1',
      buffs: [
  ...
  [
    42,
    {
      ...
      description: 'Внучок, я что-то нажала и все исчезло. Повышает производительность набожной старушки в 2 раза',
      cost: 13250,
      point: 25,
      informerIndex: '1',
      buffs: [
  ...
  [
    43,
    {
      ...
      description:  'После причащения бабушка смотрит картинки две недели без остановки. Повышает производительность набожной старушки в 2 раза',
      cost: 350000,
      point: 50,
      informerIndex: '1',
      buffs: [
  ...
  [
    ...
    {
      name: 'Пузырь спирту',
      description: 'Гуляй, дружина! Повышает производительность казачьей кибердружины в 2 раза',
      cost: 2600,
      point: 2,
      informerIndex: '2',
      buffs: [
  ...
  [
    ...
    {
      name: 'Кибернагайки',
      description: 'Новейшие технологии позволяют стегать экстремистов прямо в интернете. Повышает производительность казачьей кибердружины в 2 раза',
      cost: 3850,
      point: 5,
      informerIndex: '2',
      buffs: [
  ...
  [
    ...
    {
      name: 'Контракт с МВД',
      description:  'От охраны дач к охране интернет-пространства: теперь ваши казаки смогут ни в чем себе не отказывать. Повышает производительность казачьей кибердружины в 2 раза',
      cost: 53000,
      point: 25,
      informerIndex: '2',
      buffs: [
  ...
  [
    47,
    {
      ...
      description:  '+25 к важности каждого казака. Повышает производительность казачьей кибердружины в 2 раза',
      cost: 1400000,
      point: 50,
      informerIndex: '2',
      buffs: [
  ...
  [
    ...
    {
      name: 'Новый алгоритм',
      description:  'Бип-бип-буп. Повышает производительность АВТОДОНОСА 3000 в 2 раза',
      cost: 19500,
      point: 2,
      informerIndex: '3',
      buffs: [
  ...
  [
    ...
    {
      name: 'Армия ботов',
      description:  'БЖЖЖЖЖЖ. Повышает производительность АВТОДОНОСА 3000 в 2 раза',
      cost: 30000,
      point: 5,
      informerIndex: '3',
      buffs: [
  ...
  [
    50,
    {
      ...
      description:  '[ВВЕДИТЕ ВАШИ ДАННЫЕ]. Повышает производительность АВТОДОНОСА 3000 в 2 раза',
      cost: 400000,
      point: 25,
      informerIndex: '3',
      buffs: [
